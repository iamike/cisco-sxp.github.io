...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      ...
      compileCisco:{
        options: {
          ...
          sourceMap: true,
          outputSourceFiles: true,
          sourceMapURL: 'cisco.css.map',
          sourceMapFilename: 'docs/assets/css/cisco.css.map'
        },
        files: {
    ...
    cssmin: {
      ...
      cisco:{
        src:['docs/assets/css/cisco.css'],
        dest:'docs/assets/css/cisco.min.css'
      }
    },
    ...
    watch: {
      ...
      ciscoJs:{
        files:['docs/assets/js/_cisco/*.js'],
        tasks: 'uglify:ciscoJs'
      }
    },
